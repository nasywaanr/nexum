...
$itungcust = mysqli_query($conn, "select count(iduser) as jumlahcust from login where role='Member'");
$itungcust2 = mysqli_fetch_assoc($itungcust);
$itungcust3 = $itungcust2['jumlahcust'];

$query = "SELECT idkonfirmasi FROM konfirmasi ORDER BY idkonfirmasi";
...
<head>
    ...
    <title>Admin Panel - Nexum E-Commerce</title>
